...
# Adjusted to assume streamlit_app.py is at the project root
# ============================================================

# Directory containing streamlit_app.py (which is now the project root)
BASE_DIR = Path(__file__).resolve().parent

# Model is inside models/ (relative to BASE_DIR)
MODEL_PATH = (
    BASE_DIR /
    "models" /
...
# Training data is inside artifacts/ (relative to BASE_DIR)
